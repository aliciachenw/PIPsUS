        ...
        if np.random.rand() > 0.5: # skip half of the data
            ...
            for jj in range(S-sequence_length):
                ...
                if jj == 0:
                    ...
                    preds_coords, _, _  = student_model(trajs_previous, image_previous=image_previous, image_curr=rgbs[:,jj+sequence_length], iters=iters, beautify=False)
                else:
                    ...
                    preds_coords, _, _  = student_model(trajs_previous_, image_previous=image_previous, image_curr=rgbs[:,jj+sequence_length], iters=iters, beautify=False)
...
def train(
    ...
    _ = saverloader.load('./checkpoints/pipsUScorrMICCAI_echo_i6_S5_size256_256_kpsift_lr5e-4_A_Feb27_warmup', student_model, model_name='model')
