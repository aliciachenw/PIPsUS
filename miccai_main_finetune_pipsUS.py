...
from ultrasound.pseudo_label_v3 import generate_pseudo_gt as generate_pseudo_gt_pips2
from ultrasound.data import USDataset  as RealUSDataset
from ultrasound.sanity_check_data import USDataset as RandomUSDataset
from ultrasound.sanity_check_pseudo_label import generate_pseudo_gt as generate_pseudo_gt_random
import random
...
def train(
    ...
    exp_name = 'Feb25_finetune' 
        
    if init_dir:
        init_dir = '%s/%s' % (ckpt_dir, init_dir)
        
    # autogen a descriptive name
    model_name = "pipsUSMICCAI"
    ...
    # load dataset
    print("loading data...")
    dataset_t = RealUSDataset('train', reshape_size)
    dataset_v = RealUSDataset('valid', reshape_size)
    dataset_t2 = RandomUSDataset('train', reshape_size)
    ...
    _ = saverloader.load('./checkpoints/pipsUSMICCAI_i6_S5_size256_256_kpsift_lr5e-4_A_Feb22_warmup', student_model, model_name='model')
