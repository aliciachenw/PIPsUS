...
if os.name == 'nt':
    PSEUDO_LABEL_PATH = 'D:/Wanwen/TORS/us_us_registration_dataset/2D_cleaned_v2_pseudo20new'
else:
    PSEUDO_LABEL_PATH = '/workspace/us_seq_dataset/2D_cleaned_v2_pseudo20new'
