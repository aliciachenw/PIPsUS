    ...
    for i, data in enumerate(dataloader):
        ...
        for jj in range(S-sequence_length):
            ...
            if jj == 0:
                ...
                preds_coords = student_model(trajs_previous_, image_previous=image_previous, image_curr=rgbs[:,jj+sequence_length], iters=iters, beautify=True)
